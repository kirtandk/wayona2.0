...
import {Box, Typography, Grid, Slide, Container} from "@mui/material";
...
const GLitePage = () => {
    ...
    useEffect(() => {
        ...
        const timer1 = setTimeout(() => setAnimateLeft(true), 1000); // Left part after 1000ms
        const timer2 = setTimeout(() => setAnimateBottom(true), 2000); // Bottom part after 2000ms
        const timer3 = setTimeout(() => setAnimateRight(true), 3000); // Right part after 3000ms
